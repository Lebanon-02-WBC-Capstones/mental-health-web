...
import shrinkImg from "../amy-lee.jpg";
    ...
    return (
        <>
         ...
         <div className="flex flex-col justify-center bg-white" style={{height: "100vh"}}>
            ...
            <div className="shrinkBody w-full bg-gray-300 p-8 flex justify-center items-center"style={{height: "60%"}}>
                <div className="h-full rounded-xl bg-white p-8 w-4/5" style={{boxShadow: "0px 0px 10px grey"}}>
                    <h3 className="text-green-700">ABOUT ME</h3>
                    <p className="text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas porttitor dictum metus quis lobortis. Integer sed lacus quis quam pretium venenatis non eget dolor. Nulla facilisi. Mauris bibendum dictum sapien, a pharetra augue facilisis at. Etiam odio metus, commodo in nunc ut, egestas dignissim nunc. Suspendisse vitae mi a nibh volutpat ultricies tempor ut ex. Donec quam est, faucibus sed ultricies sit amet, viverra sit amet mauris. Curabitur massa augue, tincidunt ut auctor ac, facilisis id turpis. Ut eu enim urna. Cras velit libero, rutrum nec est sed, aliquam auctor erat.</p>
